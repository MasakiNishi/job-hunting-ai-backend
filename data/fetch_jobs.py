...
def main():
    ...
    results of fetch_job_listings in google_listings.json. It attempts
    to pull 1000 jobs, but may pull less due to rate limiting."""
    # Set API key
    api_key = os.getenv('API_KEY')
    if not api_key:
        raise ValueError("Error with API key.")
    # Here are the 25 technical job types we would like to search for:
    job_types = [
        'Software Engineer', 'Data Analyst', 'Data Scientist',
        'Software Developer', 'Software Engineer Intern',
        'Network Engineer', 'DevOps Engineer', 'Cybersecurity',
        'Cloud Engineer', 'Blockchain Developer', 'Game Developer',
        'IT Manager', 'Database Administrator', 'Software Tester',
        'Systems Analyst', 'Full Stack Developer', 'Mobile App Developer',
        'Embedded Systems Engineer', 'Robotics Engineer', 'Data Engineer',
        'UX Designer', 'Intern', 'Bioinformatics', 'Remote', 'Hybrid'
    ]
    # Set the number of jobs listings to fetch to 40 * 25 = 1000
    num_listings = 40
